...
# NOTE: pip imports FIXME/__init__.py which sets up the log
...
from FIXME.utils.paths import get_log_file_path, get_logger_config_path
...
def set_up_logger(config: Optional[Dict[str, Any]] = None) -> None:
    ...
    if YAML:
        ...
        config["handlers"]["file_handler"]["filename"] = str(
            get_log_file_path(name="FIXME.log")
        )
